...
using namespace std;
    ...
    cout << "Base number of adjacent inversions: " << count_inversionsx(data, data + size -1) << endl;
    ...
    if (count_inversionsx(data + 5, data + size - 1) > 0) {
    ...
    if (count_inversionsx(data + 6, data + size - 1) > 0) {
    ...
    if (count_inversionsx(data + 1, data + size - 1) > 0)
    ...
    if (count_inversionsx(data + 2, data + size - 1) > 0) {
    ...
    if (count_inversionsx(data + 3, data + size - 1) > 0) {
    ...
    if (count_inversionsx(data + 4, data + size - 1) > 0) {
